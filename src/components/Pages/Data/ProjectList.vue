...
//                        self.getAllProjects();
            ...
            hotYearChange() {
//				alert(this.form.hotYear);
//				alert(JSON.stringify(this.form.hotYear));
                console.log("hotFile" + JSON.stringify(this.form.hotFile));
                console.log("hotYear" + JSON.stringify(this.form.hotYear));
//				if (this.form.hotFile != []) {
            ...
            coldYearChange() {
                console.log("coldFile" + JSON.stringify(this.form.coldFile));
                console.log("coldYear" + JSON.stringify(this.form.coldYear));
